...
public class CCOPostController {
    ...
    private CCODashboardController ccoDashboardController;
    ...
    public void setUserData(User user, CCODashboardController cc) {
        this.usr = user;
        this.ccoDashboardController = cc;
    }
    ...
    public void ShowCampers() throws IOException {
        this.ccoDashboardController.handleCCClick();
    }
